package locked.me.org;

import java.util.Scanner;

import locked.me.org.repository.UserRepo;
...
public class AppStart {
	...
	public static void main(String[] args) {
		...
		int userId;
			...
			System.out.println("Craeted By - Suman Gayen");
			System.out.println("Contact Details - sumangayen588@gmail.com");
			System.out.println("+++++++ Happy User +++++");
			System.out.println("\n Please choose the Options");
			System.out.println("[][]------- Kinldy choose an option from the below List -----[][]");
			System.out.println("1. Add the files by your User ID & file name ... ");
			System.out.println("2. Search your files by your User ID... ");
			System.out.println("3. Get All files By Admin - Ascending Order... ");
			System.out.println("4. Delete a file by Your User ID & File Name... ");
			System.out.print("\n ====== !!! Disclaimer : To Quit Kindly press y or Y !!! ========");
